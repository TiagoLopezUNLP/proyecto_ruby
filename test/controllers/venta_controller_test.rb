...
class VentaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ventum" do
    assert_difference("Ventum.count") do
      post venta_url, params: { ventum: { NyA_comprador: @ventum.NyA_comprador, dni_comprador: @ventum.dni_comprador, empleado_id: @ventum.empleado_id, fecha: @ventum.fecha, total: @ventum.total } }
    end
  ...
  test "should update ventum" do
    patch ventum_url(@ventum), params: { ventum: { NyA_comprador: @ventum.NyA_comprador, dni_comprador: @ventum.dni_comprador, empleado_id: @ventum.empleado_id, fecha: @ventum.fecha, total: @ventum.total } }
