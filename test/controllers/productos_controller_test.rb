...
class ProductosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should update producto" do
    patch producto_url(@producto), params: { producto: { autor_id: @producto.autor_id, categoria_id: @producto.categoria_id, descripcion: @producto.descripcion, estado: @producto.estado, fecha_baja: @producto.fecha_baja, fecha_ingreso: @producto.fecha_ingreso, fecha_modificacion: @producto.fecha_modificacion, nombre: @producto.nombre, precio: @producto.precio, stock: @producto.stock, tipo: @producto.tipo } }
